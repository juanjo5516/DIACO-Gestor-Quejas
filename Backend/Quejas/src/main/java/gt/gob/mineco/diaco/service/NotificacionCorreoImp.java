...
public class NotificacionCorreoImp {
     ...
     * @param pCuerpo Cuerpo del correo
     * @return Bandera que identifica si el correo se envio o no.
     */
    public boolean enviarNotificacion(String pDestinatario, String pNombre, String pCuerpo) {
        ...
        System.out.println("pCuerpo: " + pCuerpo);
