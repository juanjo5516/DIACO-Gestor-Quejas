...
@NamedQueries({
@NamedQuery(name="TipoMagicLink.findAll", query="SELECT t FROM TipoMagicLink t where t.linkcode = :linkcode and t.estado = 'A' order by t.id desc"),
@NamedQuery(name="TipoMagicLink.findLastxIDQueja", query="SELECT t FROM TipoMagicLink t where t.id_queja = :id_queja and t.id_fuente = :id_fuente and t.estado = 'A' order by t.id desc"),
@NamedQuery(name="TipoMagicLink.findLastsinIDQueja", query="SELECT t FROM TipoMagicLink t where t.id_fuente = :id_fuente and t.estado = 'A' order by t.id desc")
})
public class TipoMagicLink implements Serializable {
