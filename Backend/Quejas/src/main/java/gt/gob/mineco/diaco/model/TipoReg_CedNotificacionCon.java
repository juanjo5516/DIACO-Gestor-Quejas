...
/**
 * The persistent class for the reg_cedula_notificacion_con database table.
 * 
 */
@Entity
@Table(name="reg_cedula_notificacion_con")
@NamedQuery(name = "TipoReg_CedNotificacionCon.findAll",query = "SELECT t FROM TipoReg_CedNotificacionCon t where t.id_audiencia = :id_audiencia")
public class TipoReg_CedNotificacionCon implements Serializable {
	...
	public TipoReg_CedNotificacionCon() {
	}
