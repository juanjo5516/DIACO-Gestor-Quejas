...
/**
 * The persistent class for the reg_cedula_citacion_pro database table.
 * 
 */
@Entity
@Table(name="reg_cedula_citacion_pro")
@NamedQueries({
@NamedQuery(name = "TipoReg_CedCitacionPro.findAll",query = "SELECT t FROM TipoReg_CedCitacionPro t where t.id_audiencia = :id_audiencia"),
    @NamedQuery(name = "TipoReg_CedCitacionPro.findByIdQueja",query = "SELECT t FROM TipoReg_CedCitacionPro t where t.id_queja = :id_queja")
}
)
public class TipoReg_CedCitacionPro implements Serializable {
	...
	@Column(name="solucion")
        ...
        @Column(name="zona")
        private String zona;
        @Column(name="hist_fecha_citas")
        private String hist_fecha_citas;
    ...
    /**
     * @return the hist_fecha_citas
     */
    public String getHist_fecha_citas() {
        return hist_fecha_citas;
    }

    /**
     * @param hist_fecha_citas the hist_fecha_citas to set
     */
    public void setHist_fecha_citas(String hist_fecha_citas) {
        this.hist_fecha_citas = hist_fecha_citas;
    }
