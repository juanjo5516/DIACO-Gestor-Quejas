...
@NamedQueries({
@NamedQuery(name = "TipoDepartamento.findAll", query = "SELECT t FROM TipoDepartamento t where t.habilitado='1'"),   
@NamedQuery(name = "TipoDepartamento.findAllComboDiaInhabil", query = "SELECT t FROM TipoDepartamento t where t.habilitado='1' or t.codigo_departamento=10000")  
})
