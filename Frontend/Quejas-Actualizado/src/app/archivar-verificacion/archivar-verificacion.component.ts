...
@Component({
  selector: 'app-archivar-verificacion',
  templateUrl: './archivar-verificacion.component.html',
  styleUrls: ['./archivar-verificacion.component.css'],
  animations: [
		trigger('EnterLeave', [
...
export class ArchivarVerificacionComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<ArchivarVerificacionComponent>, private _finalizarService:FinalizarService, private _quejaService: QuejaService, private _registrosservice:RegistrosService, private _seguridadService:SeguridadService) { 
