...
var QuejaextComponent = /** @class */ (function () {
                        ...
                        _this.uploader.onBeforeUploadItem = function (removeItem) {
                            ...
                            for (var i = 0; i < _this.uploader.queue.length; i++) {
                                ...
                                if (removeItem_1 == _this.dpi) {
                                    ...
                                    _this.uploader.queue[i].url = BASE_URL_REST_FILE + 'quejasini/upload?id_queja=' + _this.vidqueja + "&id_categoria_imagen=" + 2 + "&correo=0&data=0";
                                    ...
                                    if (removeItem_1 == _this.factura) {
                                        ...
                                        _this.uploader.queue[i].url = BASE_URL_REST_FILE + 'quejasini/upload?id_queja=' + _this.vidqueja + "&id_categoria_imagen=" + 3 + "&correo=0&data=0";
                                        console.log(_this.uploader.queue[i].url);
                                        console.log(removeItem_1);
                                    }
                                    else {
                                        console.log("cambia url otro");
                                        _this.uploader.queue[i].url = BASE_URL_REST_FILE + 'quejasini/upload?id_queja=' + _this.vidqueja + "&id_categoria_imagen=" + 1 + "&correo=0&data=0";
                                        console.log(_this.uploader.queue[i].url);
                                        console.log(removeItem_1);
                                    }
                                }
    ...
    QuejaextComponent = tslib_1.__decorate([
        Component({
...
export { QuejaextComponent };
//# sourceMappingURL=quejaext.component.js.map