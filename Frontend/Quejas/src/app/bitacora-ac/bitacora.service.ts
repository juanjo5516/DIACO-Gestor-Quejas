...
export class BitacoraService {
  ...
  addData (bitacora, consumidor, no_queja, flujo): Observable<any> {
		...
		return this._http.post<any>(this.baseUrl, this.ObjaJSON_add(bitacora, consumidor, no_queja, flujo), this.httpOptions).pipe(
  ...
  editData (id, bitacora, consumidor, no_queja, flujo): Observable<any> {
		...
		return this._http.put<any>(this.baseUrl, this.ObjaJSON_edit(id, bitacora, consumidor,no_queja, flujo), this.httpOptions).pipe(
  ...
  ObjaJSON_add(bitacora, consumidor, no_queja, flujo){
	  var locarray = { usuario:this._submitFormService.Get_userid(),bitacora: this.TrimandCut(bitacora,999), consumidor: this.TrimandCut(consumidor,999), id_queja: no_queja, id_sede_diaco_operacio: 1, id_departamento_interno:1, id_flujo:flujo, token: this._submitFormService.Get_token() };
  ...
  ObjaJSON_del(id,no_queja, flujo){
	  var locarray = { usuario:this._submitFormService.Get_userid(), id:id, id_sede_diaco_operacio: 1, id_departamento_interno:1, id_queja:no_queja,id_flujo:flujo, token: this._submitFormService.Get_token() };
	  //console.log(bitacora+'-'+consumidor+'-'+no_queja);
	  //console.log(locarray);
	  return JSON.stringify(locarray);
  }
  
  ObjaJSON_edit(id, bitacora, consumidor,no_queja, flujo){
	  var locarray = { usuario:this._submitFormService.Get_userid(),bitacora: bitacora, consumidor: consumidor, id:id, id_sede_diaco_operacio: 1, id_departamento_interno:1, id_queja:no_queja,id_flujo:flujo, token: this._submitFormService.Get_token() };
	  //console.log(bitacora+'-'+consumidor+'-'+no_queja);
	  //console.log(locarray);
	  return JSON.stringify(locarray);
  }
